...
window.addEventListener("DOMContentLoaded", function () {
  ...
  function modal() {
    var modalTrigger = document.querySelectorAll("[data-modal]"); //   console.log(modal, 'modal');  //'.popup_calc_end'
    ...
    modalTrigger.forEach(function (btn) {
      ...
      btn.addEventListener('click', function (e) {
        if (e.target.dataset.modal === 'popup') {
          var _modal = modalCall,
              modalPopupClose = _modal.querySelector('.popup_close');
        ...
        if (e.target.dataset.modal === 'popup-engineer') {
          var _modal2 = modalEngineer,
              _modalPopupClose = _modal2.querySelector('.popup_close');

          console.log(_modalPopupClose, 'close eng');
          openModal(modalEngineer, _modalPopupClose);
        }
      });
    });
  }
